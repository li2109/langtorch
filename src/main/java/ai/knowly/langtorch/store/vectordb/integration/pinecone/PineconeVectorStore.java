...
public class PineconeVectorStore implements VectorStore {
  ...
  /**
   * Private constructor used by the static factory methods to create a new instance of
   * PineconeVectorStore.
   *
  ...
  public static PineconeVectorStore ofOpenAI(
      ...
      Optional<String> textKey,
      Optional<String> model) {
    return create(OpenAIEmbeddingsProcessor.create(), pineconeService, namespace, textKey, model);
  }
  ...
  /**
   * Creates a new instance of PineconeVectorStore with OpenAI embeddings using default
   ...
   * @return A new instance of PineconeVectorStore.
   */
  public static PineconeVectorStore ofOpenAI(FluentLogger logger, Optional<String> model) {
  ...
  public UpsertResponse addDocuments(List<DomainDocument> documents) {
    ...
    List<Vector> vectors =
        documents.stream().map(this::createVector).collect(Collectors.toCollection(ArrayList::new));
  ...
  private Vector createVector(DomainDocument document) {
    ...
    EmbeddingInput embeddingInput =
        new EmbeddingInput(model.orElse(DEFAULT_MODEL), Collections.singletonList(text), null);
  ...
  public List<Pair<DomainDocument, Double>> similaritySearchVectorWithScore(
      List<Double> query, Long k, @Nullable Map<String, String> filter) {
    ...
    if (response.getMatches() != null) {
      for (Match match : response.getMatches()) {
        ...
        Metadata metadata =
            match.getMetadata() == null ? Metadata.create() : Metadata.create(match.getMetadata());
   ...
   * @param textKey An optional key used to retrieve text content from the document's metadata. Can
   *     be empty.
  ...
  public static PineconeVectorStore fromDocuments(
    ...
    PineconeVectorStore pineconeVectorStore =
        new PineconeVectorStore(processor, service, namespace, textKey, model);
