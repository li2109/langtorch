...
public class ApiEndPointUtils {
  ...
  public static String getPineconeEndPointFromEnv(Optional<FluentLogger> logger) {
    String endpointFromEnv = getVectorStoreEndpointFromEnv(VectorStoreApiEndpoint.PINECONE_ENDPOINT);
    logger.ifPresent(l -> logEndPoint(l, VectorStoreApiEndpoint.PINECONE_ENDPOINT.name(), endpointFromEnv));
